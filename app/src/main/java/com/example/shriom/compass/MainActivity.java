package com.example.shriom.compass;
...
public class MainActivity extends AppCompatActivity implements SensorEventListener {
    ...
    protected void onResume() {
        super.onResume();
        if(sensor!=null){
            sensorService.registerListener(this ,sensor , sensorService.SENSOR_DELAY_FASTEST);
        }else{
    ...
    public void onSensorChanged(SensorEvent sensorEvent) {
        ...
        tv_degree.setText(Integer.toString(degree) + (char)0x00B0);
